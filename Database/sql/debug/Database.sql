...
:setvar DefaultDataPath "c:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS2008R2\MSSQL\DATA\"
:setvar DefaultLogPath "c:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS2008R2\MSSQL\DATA\"
...
CREATE DATABASE [$(DatabaseName)]
    ON 
    PRIMARY(NAME = [TestApp], FILENAME = N'$(DefaultDataPath)TestApp.mdf')
    LOG ON (NAME = [TestApp_log], FILENAME = N'$(DefaultLogPath)TestApp_log.ldf') COLLATE SQL_Latin1_General_CP1_CI_AS
GO
